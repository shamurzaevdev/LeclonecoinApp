...
final class SelectedCategoryViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let mockArticles = [
            ArticlesData(id: 1, categoryId: 1, title: "Mock Title 1", description: "Mock Description", imagesUrl: nil, price: 10, creationDate: "2023-05-31", isUrgent: true, siret: nil),
            ArticlesData(id: 2, categoryId: 1, title: "Mock Title 2", description: "Mock Description", imagesUrl: nil, price: 20, creationDate: "2023-05-31", isUrgent: false, siret: nil)
        ]
